                ...
                <div className='relative min-h-screen left-[-480px] '>
                    <div className='relative z-9 dark:top-[110px]'>
                      <Button
                          SvgIcon={() =>
                            dark ?(
                              <Image src="/buttons/moon.png" alt="Example Icon" width={286} height={270}  />
                            ) : (
                              <Image src="/buttons/sun.svg" alt="Example Icon" width={686} height={606}  />
                            )
            ...
            <div className='absolute z-40 '>
              ...
              {showBox && (
                ...
                >
                    ...
                    {dark ? (
                      <Image src="/mario HereDark.svg" alt="" width={498} height={129} />
                    ) : (
                  ...
                  <div className="flex flex-row justify-between space-x-20 p-10 items-end"> 
                    <Button
                      SvgIcon={() => 
                      dark ? (
                        <Image src="/buttons/aboutDark.svg" alt="About dark" width={128} height={115}  />
                      ) : (
                        <Image src="/buttons/about.svg" alt="About" width={128} height={115}  />
                      )
                      } // Use next/image
                      altText="about"
                    ...
                    <Button
                      SvgIcon={() => 
                        dark ? (
                          <Image src="/buttons/workDark.svg" alt="work dark" width={128} height={115}  />
                        ) : (
                          <Image src="/buttons/work.svg" alt="work" width={128} height={115}  />
                        )
                        }
                      altText="work"
                    ...
                    <Button
                      SvgIcon={() => 
                        dark ? (
                          <Image src="/buttons/contactDark.svg" alt="contact dark" width={128} height={115}  />
                        ) : (
                          <Image src="/buttons/contact.svg" alt="contact" width={128} height={115}  />
                        )
                        }
                      altText="contact"
                    ...
                    <Button
                      SvgIcon={() => 
                        dark ? (
                          <Image src="/buttons/galleryDark.svg" alt="gallery dark" width={128} height={115}  />
                        ) : (
                          <Image src="/buttons/gallery.svg" alt="galley" width={128} height={115}  />
                        )
                        }
                      altText="gallery"
