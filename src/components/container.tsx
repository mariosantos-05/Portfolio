...
export default function ContainerBox({ name, children }: ContainerBoxProps) {
  return (
    <div className="relative bg-[#D7F3FF] rounded-[22px] ring-[4px] ring-[#1DA4A4] outline-offset-[0px] dark:bg-[#31466A] dark:outline-[#FDEBA1]  shadow-lg/40 shadow-cyan-900 dark:shadow-cyan-500">
